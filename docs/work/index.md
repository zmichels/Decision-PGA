...
Start with `DPGA-E005` for the latest completed healthcare publication article.
`DPGA-E004` covers the document-extraction gap bridge. `DPGA-E003` covers the broader application-gap review, article, and
